...
BEGIN
    ...
    BEGIN TRY
		...
		SET @pC_Comando = 'Insertar nuevo documento con id: ' + @TN_DocumentoID;
        EXEC GD.PA_InsertarBitacora 
            @pN_UsuarioID = @pN_UsuarioID,
            @pC_Operacion = @pC_Operacion,
            @pC_Comando = @pC_Comando,
		...
		SET @pC_Comando = 'Insertar relaciones de documento del documento: ' + @TN_DocumentoID;
        EXEC GD.PA_InsertarBitacora 
            @pN_UsuarioID = @pN_UsuarioID,
            @pC_Operacion = @pC_Operacion,
            @pC_Comando = @pC_Comando,
...
BEGIN
    ...
    BEGIN TRY
		...
		SET @pC_Comando = 'Actualiza documento con id: ' + @pN_Id;
        EXEC GD.PA_InsertarBitacora 
            @pN_UsuarioID = @pN_UsuarioID,
            @pC_Operacion = @pC_Operacion,
            @pC_Comando = @pC_Comando,
        ...
        BEGIN
			...
			IF NOT EXISTS (SELECT 1 FROM GD.TGESTORDOCUMENTAL_DocTo WHERE TN_Id = @DoctoID)
            BEGIN
		...
		SET @pC_Comando = 'Actualizar relaciones de documento del documento: ' + @pN_Id;
        EXEC GD.PA_InsertarBitacora 
            @pN_UsuarioID = @pN_UsuarioID,
            @pC_Operacion = @pC_Operacion,
            @pC_Comando = @pC_Comando,
