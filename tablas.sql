...
CREATE TABLE GD.TGESTORDOCUMENTAL_Documento (
    ...
    TC_Descripcion NVARCHAR(1000) NULL,
    TN_CategoriaID INT,
    TN_TipoDocumento INT,
    TN_OficinaID INT, 
    TC_Vigencia NVARCHAR(255) NULL,
    TN_EtapaID INT,
    TN_DocTo INT NULL,
    TB_Activo BIT,
    TB_Descargable BIT,
    TB_Eliminado BIT NOT NULL CONSTRAINT DFDocumentoEliminado DEFAULT 0,
    TN_SubClasificacionID INT NULL,
...
CREATE TABLE GD.TGESTORDOCUMENTAL_Documento_PalabraClave(
    TN_DocumentoID INT,
    TC_PalabraClave NVARCHAR(255),
    CONSTRAINT FKDocumento_Documento_PalabraClave FOREIGN KEY (TN_DocumentoID) REFERENCES GD.TGESTORDOCUMENTAL_Documento(TN_Id)
);
...
CREATE TABLE GD.TGESTORDOCUMENTAL_BitacoraMovimientos (
    TN_IdMovimiento INT PRIMARY KEY IDENTITY,
    TN_VersionID INT NOT NULL,
    TF_FechaIngreso DATETIME DEFAULT GETDATE(),
    TN_UsuarioID INT NOT NULL,
    TB_Movimiento BIT NOT NULL,
    CONSTRAINT FK_BitacoraMov_Version FOREIGN KEY (TN_VersionID) REFERENCES GD.TGESTORDOCUMENTAL_Version(TN_Id),
    CONSTRAINT FK_BitacoraMov_Usuario FOREIGN KEY (TN_UsuarioID) REFERENCES SC.TGESTORDOCUMENTAL_Usuario(TN_Id)
);
